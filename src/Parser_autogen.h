...
namespace parser {
#line 173 "Parser_autogen.h" // lalr1.cc:401
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::TOKEN_NUMBER);
      }
#else
    ...
    Parser (parser::Lexer& lexer_yyarg, parser::ParsingContext& context_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_PACKAGE (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOKEN_PACKAGE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#endif // !YY_YY_PARSER_AUTOGEN_H_INCLUDED
